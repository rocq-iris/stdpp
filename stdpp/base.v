...
(** These [Hint Mode] declarations are missing in the stdlib. These
hint modes prevent instantiating [?R] with an arbitrary relation when
searching for [@Reflexive ?A ?R], but allow finding an instance for
[@Reflexive ?A (@eq ?A)]. *)
