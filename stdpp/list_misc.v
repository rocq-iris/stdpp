...
NOTE: there are no lemmas about this function; it exists solely to facilitate
the proof if decidability of [submseteq] and [≡ₚ]. *)
...
it cannot be in [list_relations]. It is found here instead. *)
